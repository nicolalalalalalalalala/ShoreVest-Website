(function (root, factory) {
  ...
  var STRINGS = {
    en: {
      unavailable: 'Applications are not available at this time.',
      notFound: 'This position could not be found.',
      closed: 'Applications are not currently being accepted for this position.',
      ...
      accuracy: 'Please confirm that the information is accurate.',
      bot: 'Please complete the security check.',
      submit: 'Submit application',
      submitting: 'Submitting…',
      generic: 'Your application could not be submitted. Please try again.',
      network: 'Your application could not be submitted. Please check your connection and try again.',
      rate: 'Too many attempts were received. Please wait and try again.',
      successTitle: 'Application received',
      successBody: 'Your application has been securely received by ShoreVest.',
