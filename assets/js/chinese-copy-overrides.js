(function () {
  ...
  var OVERRIDES = [
    ...
    ["FEATURED IN", "曾获报道媒体"],
    ["Bloomberg, Reuters, The Economist, Nikkei Asia and SCMP", "彭博, 路透社, 《经济学人》, 日经亚洲, 南华早报"],
    ["END OF ARCHIVE", "档案结束"],
    ...
    ["Asset-backed lending, asset restructuring and debt resolution", "资产支持型借贷, 资产重组, 债务处置"],
